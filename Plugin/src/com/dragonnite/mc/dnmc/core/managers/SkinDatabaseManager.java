...
import com.dragonnite.mc.dnmc.core.utils.HttpRequest;
...
public class SkinDatabaseManager {
    private final Plugin plugin = DragonNiteMC.plugin;
    ...
    private String[] requestSkin(UUID uuid) throws IOException {
        DragonNiteMC.plugin.getLogger().info("Requesting httprequests....");
