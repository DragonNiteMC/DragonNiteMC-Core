...
import com.dragonnite.mc.dnmc.core.misc.world.WorldProperties;
...
public class WorldListeners implements Listener {
    ...
    public void onPvPAndPve(EntityDamageByEntityEvent e) {
        ...
        try {
            properties = DragonNiteMC.getDnmcWorldManager().getWorldProperties(e.getEntity().getWorld().getName());
    ...
    public void onWorldLoad(WorldLoadEvent e) {
        ...
        if (DragonNiteMC.getDnmcWorldManager().getWorldList().containsKey(name)) return;
        DragonNiteMC.getDnmcWorldManager().createProperties(e.getWorld());
    }
}
