package com.dragonnite.mc.dnmc.core.factory.builder;
...
import com.dragonnite.mc.dnmc.core.managers.builder.AbstractItemStackBuilder;
...
public final class ItemStackFactory implements AbstractItemStackBuilder {
    ...
    public AbstractItemStackBuilder openGui(Supplier<Inventory> inventorySupplier) {
        return this.onClick(e -> DragonNiteMC.getAPI().getCoreScheduler().runTask(() -> e.getWhoClicked().openInventory(inventorySupplier.get())));
    }
    ...
    public void buildWithSkin(Consumer<ItemStack> callback) {
        ...
        if (this.skinName != null && this.skinUniqueId != null) {
            DragonNiteMC.getAPI().getPlayerSkinManager().setSkullMeta(this.skinUniqueId, this.skinName, item, callback);
        } else if (this.skinUniqueId != null) {
            DragonNiteMC.getAPI().getPlayerSkinManager().setSkullMeta(this.skinUniqueId, item, callback);
        } else {
    ...
    public ItemStack build() {
        ...
        if (clickAction != null) {
            ...
            DragonNiteMC.getItemEventManager().registerItem(onClickId, clickAction);
        }
        if (interactAction != null) {
            compound.put("onInteract", onInteractId);
            DragonNiteMC.getItemEventManager().registerItem(onInteractId, interactAction);
        }
