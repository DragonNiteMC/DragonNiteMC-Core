...
import com.dragonnite.mc.dnmc.core.command.dnmc.world.*;
...
import com.dragonnite.mc.dnmc.core.command.dnmc.world.setter.WorldSetMainCommand;

public class WorldMainCommand extends DefaultCommand {

    public WorldMainCommand(CommandNode parent) {
        super(parent, "world", "dragonnite.world", "管理伺服器的世界", "w");
