...
import com.dragonite.mc.dnmc.core.config.serializer.BukkitBeanModifier;
            ...
            if (ins instanceof MessageConfiguration) {
                ...
                class MessageGetterImpl implements MessageGetter {
                    ...
                    public String getPrefix() {
                        ...
                        return Optional.ofNullable(prefix).map(pre -> translate(configuration.getString(pre.path()))).orElseGet(() -> DragoniteMC.getDnmCoreConfig().getPrefix());
                    }
