...
import com.dragonnite.mc.dnmc.core.managers.builder.AbstractAdvMessageBuilder;
...
public class AdvMessageBuilder implements AbstractAdvMessageBuilder {
    ...
    public AdvMessageBuilder(String... msg) {
        this.delegate = DragonNiteMC.getAPI().getFactory().getBuilder().getAdvMessageBuilder(msg);
    }
